...
const getSocialLinks = (config): SocialLink[] => {
...
export const PageSocial: React.FC = () => {
  ...
  const dynamicSocialConfig = {
    twitter: dynamicConfig.twitter,
    github: dynamicConfig.github,
    linkedin: dynamicConfig.linkedin,
    // mastodon: dynamicConfig.mastodon,
    newsletter: dynamicConfig.newsletter,
    youtub: dynamicConfig.youtube
  }

  // override
  const socialLinks = getSocialLinks(dynamicSocialConfig)
